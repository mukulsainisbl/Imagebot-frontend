...
const Result = () => {
...

 {
  !isImageLoaded && 
    ...
    <div className='flex w-full max-w-xl h-13 bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full '>
      <input type="text" 
      onChange={e => setInput(e.target.value)} value={input}
      placeholder='Descibe what you want to generate' 
      className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-yellow-400'
      />
